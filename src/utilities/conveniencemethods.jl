...
# FairGLRM(A, loss::Loss, rx::Array, ry::Regularizer, rkx::Array, rky::Array, k::Int, s::Int, group_functional::GroupFunctional; kwargs...) =
...
# FairGLRM(A, loss::Loss, rx::Regularizer, ry::Array, rkx::Array, rky::Array, k::Int, s::Int, group_functional::GroupFunctional; kwargs...) =
...
# FairGLRM(A, loss::Loss, rx::Array, ry::Array, rkx::Array, rky::Array, k::Int, s::Int, group_functional::GroupFunctional; kwargs...) =
#     FairGLRM(A, fillcopies(loss, size(A, 2), arraytype=Loss), rx, ry, rkx, rky, k, s, group_functional; kwargs...)
# FairGLRM(A, loss::Loss, rx::Array, ry::Array, rkx::ColumnRegularizer, rky::Array, k::Int, s::Int, group_functional::GroupFunctional; kwargs...) =
#     FairGLRM(A, fillcopies(loss, size(A, 2), arraytype=Loss), rx, ry, fillcopies(rkx, k), rky, k, s, group_functional; kwargs...)
# FairGLRM(A, loss::Loss, rx::Array, ry::Array, rkx::Array, rky::ColumnRegularizer, k::Int, s::Int, group_functional::GroupFunctional; kwargs...) =
#     FairGLRM(A, fillcopies(loss, size(A, 2), arraytype=Loss), rx, ry, rkx, fillcopies(rky, k), k, s, group_functional; kwargs...)
# FairGLRM(A, loss::Loss, rx::Array, ry::Array, rkx::ColumnRegularizer, rky::ColumnRegularizer, k::Int, s::Int, group_functional::GroupFunctional; kwargs...) =
...
FairGLRM(A, loss::Loss, rx::Array, ry::Regularizer, rkx::Array, rky::Array, k::Int, s::Int, group_functional::GroupFunctional; kwargs...) =
   FairGLRM(A, fillcopies(loss, size(A, 2), arraytype=Loss), rx, fillcopies(ry, size(A, 2), arraytype=Regularizer), rkx, rky, k, s, group_functional; kwargs...)
FairGLRM(A, loss::Loss, rx::Array, ry::Regularizer, rkx::Array, rky::ColumnRegularizer, k::Int, s::Int, group_functional::GroupFunctional; kwargs...) =
...
FairGLRM(A, loss::Loss, rx::Array, ry::Regularizer, rkx::ColumnRegularizer, rky::Array, k::Int, s::Int, group_functional::GroupFunctional; kwargs...) =
...
FairGLRM(A, loss::Loss, rx::Array, ry::Regularizer, rkx::ColumnRegularizer, rky::ColumnRegularizer, k::Int, s::Int, group_functional::GroupFunctional; kwargs...) =
...
FairGLRM(A, loss::Loss, rx::Regularizer, ry::Array, rkx::Array, rky::Array, k::Int, s::Int, group_functional::GroupFunctional; kwargs...) =
   FairGLRM(A, fillcopies(loss, size(A, 2), arraytype=Loss), fillcopies(rx, size(A, 1), arraytype=Regularizer), ry, rkx, rky, k, s, group_functional; kwargs...)
FairGLRM(A, loss::Loss, rx::Regularizer, ry::Array, rkx::Array, rky::ColumnRegularizer, k::Int, s::Int, group_functional::GroupFunctional; kwargs...) =
...
FairGLRM(A, loss::Loss, rx::Regularizer, ry::Array, rkx::ColumnRegularizer, rky::Array, k::Int, s::Int, group_functional::GroupFunctional; kwargs...) =
...
FairGLRM(A, loss::Loss, rx::Regularizer, ry::Array, rkx::ColumnRegularizer, rky::ColumnRegularizer, k::Int, s::Int, group_functional::GroupFunctional; kwargs...) =
...
FairGLRM(A, loss::Loss, rx::Regularizer, ry::Regularizer, rkx::Array, rky::Array, k::Int, s::Int, group_functional::GroupFunctional; kwargs...) =
...
FairGLRM(A, loss::Loss, rx::Regularizer, ry::Regularizer, rkx::Array, rky::ColumnRegularizer, k::Int, s::Int, group_functional::GroupFunctional; kwargs...) =
...
FairGLRM(A, loss::Loss, rx::Regularizer, ry::Regularizer, rkx::ColumnRegularizer, rky::Array, k::Int, s::Int, group_functional::GroupFunctional; kwargs...) =
...
FairGLRM(A, loss::Loss, rx::Regularizer, ry::Regularizer, rkx::ColumnRegularizer, rky::ColumnRegularizer, k::Int, s::Int, group_functional::GroupFunctional; kwargs...) =
...
#FairGLRM(A, losses::Array, rx::Array, ry::Array, rkx::Array, rky::Array, k::Int, s::Int, group_functional::GroupFunctional; kwargs...) =
   #FairGLRM(A, losses, rx, ry, rkx, rky, k, s, group_functional; kwargs...)
FairGLRM(A, losses::Array, rx::Array, ry::Array, rkx::Array, rky::ColumnRegularizer, k::Int, s::Int, group_functional::GroupFunctional; kwargs...) =
   FairGLRM(A, losses, rx, ry, rkx, fillcopies(rky, k, arraytype=ColumnRegularizer), k, s, group_functional; kwargs...)
FairGLRM(A, losses::Array, rx::Array, ry::Array, rkx::ColumnRegularizer, rky::Array, k::Int, s::Int, group_functional::GroupFunctional; kwargs...) =
   FairGLRM(A, losses, rx, ry, fillcopies(rkx, k, arraytype=ColumnRegularizer), rky, k, s, group_functional; kwargs...)
FairGLRM(A, losses::Array, rx::Array, ry::Array, rkx::ColumnRegularizer, rky::ColumnRegularizer, k::Int, s::Int, group_functional::GroupFunctional; kwargs...) =
...
FairGLRM(A, losses::Array, rx::Array, ry::Regularizer, rkx::Array, rky::Array, k::Int, s::Int, group_functional::GroupFunctional; kwargs...) =
   FairGLRM(A, losses, rx, fillcopies(ry, size(A, 2), arraytype=Regularizer), rkx, rky, k, s, group_functional; kwargs...)
FairGLRM(A, losses::Array, rx::Array, ry::Regularizer, rkx::Array, rky::ColumnRegularizer, k::Int, s::Int, group_functional::GroupFunctional; kwargs...) =
...
FairGLRM(A, losses::Array, rx::Array, ry::Regularizer, rkx::ColumnRegularizer, rky::Array, k::Int, s::Int, group_functional::GroupFunctional; kwargs...) =
...
FairGLRM(A, losses::Array, rx::Array, ry::Regularizer, rkx::ColumnRegularizer, rky::ColumnRegularizer, k::Int, s::Int, group_functional::GroupFunctional; kwargs...) =
...
FairGLRM(A, losses::Array, rx::Regularizer, ry::Array, rkx::Array, rky::Array, k::Int, s::Int, group_functional::GroupFunctional; kwargs...) =
   FairGLRM(A, losses, fillcopies(rx, size(A, 1), arraytype=Regularizer), ry, rkx, rky, k, s, group_functional; kwargs...)
FairGLRM(A, losses::Array, rx::Regularizer, ry::Array, rkx::Array, rky::ColumnRegularizer, k::Int, s::Int, group_functional::GroupFunctional; kwargs...) =
...
FairGLRM(A, losses::Array, rx::Regularizer, ry::Array, rkx::ColumnRegularizer, rky::Array, k::Int, s::Int, group_functional::GroupFunctional; kwargs...) =
...
FairGLRM(A, losses::Array, rx::Regularizer, ry::Array, rkx::ColumnRegularizer, rky::ColumnRegularizer, k::Int, s::Int, group_functional::GroupFunctional; kwargs...) =
...
FairGLRM(A, losses::Array, rx::Regularizer, ry::Regularizer, rkx::Array, rky::Array, k::Int, s::Int, group_functional::GroupFunctional; kwargs...) =
...
FairGLRM(A, losses::Array, rx::Regularizer, ry::Regularizer, rkx::Array, rky::ColumnRegularizer, k::Int, s::Int, group_functional::GroupFunctional; kwargs...) =
...
FairGLRM(A, losses::Array, rx::Regularizer, ry::Regularizer, rkx::ColumnRegularizer, rky::Array, k::Int, s::Int, group_functional::GroupFunctional; kwargs...) =
...
FairGLRM(A, losses::Array, rx::Regularizer, ry::Regularizer, rkx::ColumnRegularizer, rky::ColumnRegularizer, k::Int, s::Int, group_functional::GroupFunctional; kwargs...) =
